...
public class PRESTAMO_RFINAL extends javax.swing.JFrame implements PrestamoObserver {
    ...
    PrestamoObservable.notificar("Paso2"); // Informamos que estamos en el paso anterior
    ControladorPrestamo controlador = new ControladorPrestamo(); // Asegúrate de usar una instancia global
    controlador.deshacer(); // Regresa visualmente
